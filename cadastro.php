...
<body class="fundo">
    <div id="menu">
        ...
        <form method="POST" action="cadastrar.php">
            ...
            <input type="submit"  value="Cadastrar" onclick="Alerta('cadastro')">
            <br>
        </form>
        </section >
        <div id="cadastrado">
        <p>Tem uma conta? <a href="entrar.php" value="conecte-se"   input type="submit">Conecte-se</a></p>
        </div>
    </section>
    <footer id="rodape">
	<div id="mapa"></div>
